...
urlpatterns = [
    ...
    path('dashboard/detalle_usuario/<str:tipo>/<int:usuario_id>/', views.detalle_usuario, name='detalle_usuario'),
    path("dashboard/editar_usuario/<str:tipo>/<int:usuario_id>/", views.editar_usuario, name="editar_usuario"),
    path("dashboard/guardar_usuario/<str:tipo>/<int:usuario_id>/", views.actualizar_usuario, name="actualizar_usuario"),
    path("dashboard/definir_contrato/<int:usuario_id>/", views.definir_contrato, name="definir_contrato"),
    path("dashboard/definir_contrato_usuario/<int:usuario_id>/", views.definir_contrato_usuario, name="definir_contrato_usuario"),
    ...
    path("dashboard/matriz/agregar_matriz_academica/", views.agregar_matriz_academica, name="agregar_matriz_academica"),
