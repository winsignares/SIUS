...
def gestion_estudiante(request):
    ...
    if request.method == "POST":
        ...
        if accion == "editar_pregunta":
            ...
            elif CategoriaEstudiante.objects.filter(nombre__iexact=nuevo_nombre).exclude(id=categoria_id).exists():
        ...
        return redirect(reverse('evaluacion:gestion_estudiante'))

    return render(request, 'core/crud_estudiante.html', {'categorias': categorias})
